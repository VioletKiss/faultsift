...
| M2 / FS-006–FS-009 Line Access / Index | Completed |
...
M1 completed on 2026-08-27 after FS-002 through FS-005 passed local verification, independent review, and required Windows/Ubuntu CI. M2 completed on 2026-09-01 after FS-006 through FS-009 passed local verification, independent review, and required Windows/Ubuntu CI; its Line Access / Index architecture remains the accepted ADR-0004 design. Parser, UI, and AI work remains not started.
